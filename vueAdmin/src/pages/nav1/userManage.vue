	...
	<section>
		...
		<template>
			<el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;">
				...
				<el-table-column prop="name" label="姓名" :span="4" sortable>
				</el-table-column>
				<el-table-column prop="sex" label="性别" :span="2" :formatter="formatSex" sortable>
				</el-table-column>
				<el-table-column prop="branch" label="所属机构" :span="4" sortable>
				</el-table-column>
				<el-table-column prop="role" label="角色" :span="2" sortable>
				</el-table-column>
...
<script>
	...
	import { getUserList, removeUser, editUser, addUser } from '../../api/api';
	...
	export default {
		...
		methods: {
			...
			handleEdit: function (row) {
				...
				this.editForm.branch = row.branch;
						...
						_this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							if (_this.editForm.id == 0) {
								...
								let para = {
									...
									branch: _this.editForm.branch,
									role: _this.editForm.role,
								};
